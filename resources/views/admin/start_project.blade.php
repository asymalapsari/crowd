        ...
        <div class="container">
            <div id="wrapper">
                ...
                <div id="page-wrapper">
                    ...
                    <form action="{{route('store_project')}}" method="post" class="form-horizontal">
                    {{csrf_field()}}
                            ...
                            <div class="form-group {{ $errors->has('title')? 'has-error':'' }}">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="title" value="{{ old('title') }}" name="project_name" placeholder="@lang('app.project_name')" required>
                            ...
                            <div class="form-group {{ $errors->has('short_description')? 'has-error':'' }}">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="project_description" class="form-control" rows="3" required>{{ old('project_description') }}</textarea>
                            ...
                            <div class="form-group {{ $errors->has('project_budget')? 'has-error':'' }}">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" id="project_budget" value="{{ old('project_budget') }}" name="project_budget" placeholder="@lang('app.project_budget')" required>
                            ...
                            <div class="form-group {{ $errors->has('number_of_required_applier')? 'has-error':'' }}">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" id="number_of_required_applier" value="{{ old('number_of_required_applier') }}" name="number_of_required_applier" placeholder="@lang('app.number_of_required_applier')" required>
                            ...
                            <div class="form-group {{ $errors->has('applier_requirements')? 'has-error':'' }}">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="applier_requirements" class="form-control" rows="3" required>{{ old('applier_requirements') }}</textarea>
                            ...
                            <div class="form-group {{ $errors->has('start_date')? 'has-error':'' }}">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" id="start_date" value="{{ old('start_date') }}" name="start_date" placeholder="@lang('app.start_date')" required>
                            ...
                            <div class="form-group {{ $errors->has('end_date')? 'has-error':'' }}">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" id="end_date" value="{{ old('end_date') }}" name="end_date" placeholder="@lang('app.end_date')" required>
