...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-cubes"></i> @lang('app.projects')<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>  <a href="{{route('projects')}}">@lang('app.my_projects')</a> </li>
                    <li>  <a href="{{route('start_project')}}">@lang('app.start_new_projects')</a> </li>
                </ul>
            </li>
            ...
            <li><a href="{{route('institution')}}"><i class="fa fa-institution"></i>@lang('app.institution')</a></li>
