...
@section('content')
    ...
    @if($new_campaigns->count())
        <section class="home-campaign section-bg-gray new-home-campaigns" style="height: 1200px">
            <div class="container">
    ...
    <!-- INI SECTION PROJECT -->
    <section class="home-campaign section-bg-white new-home-campaigns col-centered" style="height: 600px">
            <div class="container">

                <div class="row">
                    <div class="col-md-12">
                        <h2 class="section-title"> @lang('app.new_projects') </h2>
                    </div>
                </div>

                <div class="row">
                    <div class="box-campaign-lists">
                            @foreach($project as $np)
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 box-campaign-item">
                                <div class="box-campaign">
                                    <div class="box-campaign-image">
                                        <img src="https://source.unsplash.com/780x400/?marketing" class="img-responsive" />
                                        <div class="overlay">
                                            <a class="info" href="{{route('project_single', [$np->id])}}">View Details</a>
                                        </div>
                                    </div>
                                    <div class="box-campaign-content">
                                        <div class="box-campaign-description">
                                            <h4><a href="{{route('project_single', [$np->id])}}"> {{$np->project_name}} </a> </h4>
                                            <p>{{$np->project_description}}</p>
                                        </div>

                                        <div class="box-campaign-summery">
                                            <ul>
                                                @for ($star=1; $star<=5; $star++)
                                                    @if($np->project_rating >= $star)
                                                        <span class="glyphicon glyphicon-star"></span>
                                                    @else
                                                        <span class="glyphicon glyphicon-star-empty"></span>
                                                    @endif
                                                @endfor
                                                <!-- <li><strong>Lorem, ipsum dolor.</strong> @lang('app.days_left')</li>
                                                <li><strong>Lorem ipsum dolor sit amet.</strong> @lang('app.backers')</li>
                                                <li><strong>Lorem ipsum dolor sit amet.</strong> @lang('app.funded')</li> -->
                                            </ul>
                                        </div>
    ...
    @if($funded_campaigns->count())
        <section class="home-campaign section-bg-white" style="height: 800px">
            <div class="container">
