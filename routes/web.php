...
//projects
Route::get('project/{id}', ['as' => 'project_single', 'uses' => 'ProjectsController@show']);
Route::post('project/{id}/rating', ['as'=> 'project_rated', 'uses' => 'ProjectsController@rating']);
...
Route::group(['prefix'=>'dashboard', 'middleware' => 'auth'], function() {
    ...
    Route::group(['prefix' =>'ins'],function(){
        Route::get('/',['as'=>'institution','uses' => 'InstitutionController@index']);
        Route::get('my-institution/show',['as'=>'institution_form', 'uses'=>'InstitutionController@show']);
        Route::post('my-institution/post',['as'=>'institution_post','uses'=>'InstitutionController@store']);
    });

    Route::group(['prefix'=>'projects'], function(){
        Route::get('/','ProjectsController@index')->name('projects');

        Route::get('start_project', ['as'=>'start_project', 'uses' => 'ProjectsController@create']);
        Route::post('start_project', ['as'=> 'store_project','uses' => 'ProjectsController@store']);

        Route::get('edit_project/{id}', ['as'=>'edit_project', 'uses' => 'ProjectsController@edit']);
        Route::post('edit_project/{id}', [ 'as'=>'update_project','uses' => 'ProjectsController@update']);

        Route::post('rating_project/{id}/rating', [ 'as'=>'rating_project','uses' => 'ProjectsController@rating']);
